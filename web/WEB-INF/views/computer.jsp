...
<table class="table">
    ...
    <tr>
        <td>
            Add computer <code><strong>POST</strong></code>
        </td>
        <td>/computer/add</td>
        <td>
            <form class="form-inline">
                name: <input type="text" id="postName" value="Computer name">
                description: <input type="text" id="postDescription" value="Computer description">
    ...
    <tr>
        <td>
            Get computer by id<code><strong>GET</strong></code>
        </td>
    ...
    <tr>
        <td>
            Get all computers<code><strong>GET</strong></code>
        </td>
